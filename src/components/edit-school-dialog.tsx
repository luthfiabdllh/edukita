...
import { School, MapPin, Phone, Mail, Save } from "lucide-react"
...
export function EditSchoolDialog({ school, open, onOpenChange, onSave }: EditSchoolDialogProps) {
  const [formData, setFormData] = useState<SchoolType | null>(null)
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Edit informasi sekolah {formData.nama}</DialogDescription>
        </DialogHeader>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    disabled
                  />
                  <p className="text-xs text-muted-foreground mt-1">NPSN tidak dapat diubah</p>
                </div>
                <div>
